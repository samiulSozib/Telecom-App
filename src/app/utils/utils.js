...
export function categorizeServices(data) {
  ...
  // Set to track seen company IDs for both social and nonsocial services
      ...
      category.services.forEach(service => {
          ...
          if (type === "social") {
              ...
              if (!seenSocialCompanies.has(companyId)) {
                  ...
                  if (!categorized.social[category.category_name]) {
                      categorized.social[category.category_name] = {
                          companies: []
                      };
                  }
                  ...
                  categorized.social[category.category_name].companies.push(socialCompanyInfo);
              }
          } else {
              // Check for duplicate non-social companies
              if (!seenNonSocialCompanies.has(companyId)) {
                  seenNonSocialCompanies.add(companyId);

                  // Initialize non-social category for country
